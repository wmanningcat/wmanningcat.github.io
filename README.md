...
<body>
  ...
  <header class="hero">
    <div class="container hero-grid">
      <div>
        ...
        <p class="sub">Family Yoga Institute offers a nurturing space where moms and families can move, breathe, and grow together. Our classes are designed to support every stage of motherhood — from pregnancy to postnatal bonding and beyond.</p>
        <div class="cta">
      ...
      <div class="logo-card">
        ...
        <p style="text-align:center;margin:.6rem 0 0;color:var(--muted)"><em>“Growing together.”</em> 
  </header>
  ...
  <section id="classes" class="container">
    <div style="text-align:center;margin-bottom:26px">
      ...
      <p class="sub">Launching with prenatal and postnatal series. Future plans include childcare on-site so moms can practice without arranging a babysitter.</p>
    </div>
